...
#import "STIGQueryResultController.h"
#import "STIGFunctionEditorController.h"
...
@interface STIGMainWindowController (Private)

-(void)updateBreadCrumbs:(NSTreeNode*)descriptor;

@end 

@implementation STIGMainWindowController
...
- (BOOL)isSpecialGroup:(STIGAbstractDescriptor *)groupNode{ 
...
- (BOOL)outlineView:(NSOutlineView *)outlineView shouldSelectItem:(id)item;{
    ...
    STIGAbstractDescriptor *node = [item representedObject];
...
- (void)outlineView:(NSOutlineView *)olv willDisplayCell:(NSCell*)cell 
    ...
    if ([cell isKindOfClass:[STIGSourceListCell class]]){
        if ([self isSpecialGroup:[item representedObject]]){
            [(STIGSourceListCell*)cell setImage:nil];
        }else{
            [(STIGSourceListCell*)cell setImage:urlImage];
        }        
    }        
...
- (void)outlineViewSelectionDidChange:(NSNotification *)notification{
    ...
    STIGAbstractDescriptor *descriptor = [item representedObject];
    ...
    STIGQueryResultController *queryResultController = [[STIGQueryResultController alloc] initWithNibName:@"QueryResultView" 
                                                                                            bundle:nil 
...
-(void)updateBreadCrumbs:(NSTreeNode*)item{    
    ...
    STIGBreadCrumbCell *rNode = [[[STIGBreadCrumbCell alloc] initWithPathLabel:@"Database"] autorelease];
    STIGBreadCrumbCell *dbNode   = [[[STIGBreadCrumbCell alloc] initWithPathLabel:[[item representedObject] label]] autorelease];
...
-(void) appendBreadCrumb:(NSNotification*)notification{
    ...
    STIGBreadCrumbCell *newNode = [[[STIGBreadCrumbCell alloc] initWithPathLabel:[pathLabel description]] autorelease];
