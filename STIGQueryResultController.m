...
@interface  STIGQueryResultController (Private)
...
@implementation STIGQueryResultController
...
-(void) handleCouchDocumentSelected:(NSDictionary*)couchDocument{
    STIGMainWindowController *mainWindowController = [(STIGAppDelegate*)[NSApp delegate] mainWindowController];
    ...
    if([tmp hasPrefix:@"_design/"]){     
        STIGFunctionEditorController *functionController = [[STIGFunctionEditorController alloc] 
        ...
        STIGCouchDocumentController *documentController = [[STIGCouchDocumentController alloc]                                                                  
